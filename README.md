...
1. Customize your configuration editing `homedir/.config/opencode/opencode.jsonc` (contains an example for llama.cpp usage)
2. Customize your developement dependencies in Dockerfile
